...
df = pd.read_csv(r"datasets/Exercise.csv")
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(id='my_dropdown',
            options=[
                     {'label': 'Device', 'value': 'deviceuuid'},
                     {'label': 'time_offset', 'value': 'time_offset'},
                     {'label': 'SportType', 'value': 'exercise_type', 'disabled':False}
                     #{'label': 'Animal Condition', 'value': 'Animal Condition'},
                     #{'label': 'Borough', 'value': 'Borough'},
                     #{'label': 'Species Status', 'value': 'Species Status'}
            ],
            optionHeight=35,                    #height/space between dropdown options
            value='time_offset',                    #dropdown value selected automatically when page loads
